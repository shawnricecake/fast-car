...
if __name__ == "__main__":
    ...
    all_prompts = json.load(open("prompts/VBench2_full_info-3.json"))
    if not os.path.exists(args.save_path):
        os.makedirs(args.save_path)
    
    all_keys = list(all_prompts.keys())

    for idx, e in enumerate(all_keys):
        ...
        current_dim = all_prompts[e]['dimension']
        ...
        current_prompt = all_prompts[e]['caption']
        ...
        save_video_mp4(response, args.save_path, current_prompt[0][:180])
    ...
    all_prompts = json.load(open("prompts/VBench2_full_info-20.json"))
    all_keys = list(all_prompts.keys())
    ...
    for idx, e in enumerate(all_keys):
        ...
        for sample_idx in range(5):
            ...
            save_video_mp4(response, args.save_path, current_prompt[0][:180], sample_idx*5)
